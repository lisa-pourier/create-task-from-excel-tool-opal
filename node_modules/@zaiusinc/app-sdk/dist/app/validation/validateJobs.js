...
const cronValidator = __importStar(require("cron-expression-validator"));
const logging_1 = require("../../logging");
const Job_1 = require("../Job");
async function validateJobs(runtime) {
    const errors = [];
    ...
    if (runtime.manifest.jobs) {
        for (const name of Object.keys(runtime.manifest.jobs)) {
            ...
            else if (!(jobClass.prototype instanceof Job_1.Job)) {
...
//# sourceMappingURL=validateJobs.js.map