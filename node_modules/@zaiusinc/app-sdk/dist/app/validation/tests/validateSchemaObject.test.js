...
describe('validateSchemaObject', () => {
    it('succeeds with a proper definition', () => {
        ...
        expect((0, validateSchemaObject_1.validateSchemaObject)(runtime, schemaObjects['events.yml'], 'events.yml')).toEqual([]);
        expect((0, validateSchemaObject_1.validateSchemaObject)(runtime, schemaObjects['my_app_coupons.yml'], 'my_app_coupons.yml')).toEqual([]);
    });
    it('detects invalid names', () => {
        const runtime = Runtime_1.Runtime.fromJson(JSON.stringify({ appManifest, dirName: '/tmp/foo' }));
        const badSchemaObjects = {
            'events.yml': {
        ...
        expect((0, validateSchemaObject_1.validateSchemaObject)(runtime, badSchemaObjects['events.yml'], 'events.yml')).toEqual([
        ...
        expect((0, validateSchemaObject_1.validateSchemaObject)(runtime, badSchemaObjects['my_app_Coupons.yml'], 'my_app_Coupons.yml')).toEqual([
        ...
        expect((0, validateSchemaObject_1.validateSchemaObject)(runtime, badSchemaObjects['customers.yml'], 'customers.yml')).toEqual([
    ...
    it('does not allow display name or alias on non-custom objects', () => {
        const runtime = Runtime_1.Runtime.fromJson(JSON.stringify({ appManifest, dirName: '/tmp/foo' }));
        const badSchemaObject = {
            ...schemaObjects['events.yml'],
            display_name: 'Event-Like Stuff',
            alias: 'event_like_stuff'
        };
        expect((0, validateSchemaObject_1.validateSchemaObject)(runtime, badSchemaObject, 'events.yml')).toEqual([
    ...
    it('requires a primary key on custom objects', () => {
        ...
        expect((0, validateSchemaObject_1.validateSchemaObject)(runtime, badSchemaObject, 'my_app_coupons.yml')).toEqual([
    ...
    it('enforces custom object rules for non-prefixed objects when base object names are available', () => {
        ...
        expect((0, validateSchemaObject_1.validateSchemaObject)(runtime, badSchemaObject, 'coupons.yml', ['events'])).toEqual([
    ...
    it('requires name to match file base name', () => {
        const runtime = Runtime_1.Runtime.fromJson(JSON.stringify({ appManifest, dirName: '/tmp/foo' }));
        expect((0, validateSchemaObject_1.validateSchemaObject)(runtime, schemaObjects['events.yml'], 'something.yml')).toEqual([
    ...
    it('does allow identifiers on customers', () => {
        ...
        expect((0, validateSchemaObject_1.validateSchemaObject)(runtime, goodSchemaObject, 'customers.yml')).toEqual([]);
    });
    it('detects invalid identifier suffix', () => {
        ...
        expect((0, validateSchemaObject_1.validateSchemaObject)(runtime, badSchemaObject, 'customers.yml')).toEqual([
...
//# sourceMappingURL=validateSchemaObject.test.js.map