...
describe('validateSourceSchema', () => {
    ...
    it('should pass for valid schema and file name', () => {
        ...
        const result = (0, validateSourcesSchema_1.validateSourcesSchema)(validSchema, file);
    ...
    it('should return an error if the schema name does not match the file name', () => {
        ...
        const file = 'valid_schema.yml';
        const result = (0, validateSourcesSchema_1.validateSourcesSchema)(invalidSchema, file);
...
//# sourceMappingURL=validateSourceSchema.test.js.map