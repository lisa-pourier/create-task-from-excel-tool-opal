...
describe('validateDestinationSchema', () => {
    ...
    it('should pass for valid schema and file name', () => {
        ...
        const result = (0, validateDestinationsSchema_1.validateDestinationsSchema)(validSchema, file);
    ...
    it('should return an error if the schema name does not match the file name', () => {
        ...
        const file = 'valid_schema.yml';
        const result = (0, validateDestinationsSchema_1.validateDestinationsSchema)(invalidSchema, file);
...
//# sourceMappingURL=validateDestinationSchema.test.js.map