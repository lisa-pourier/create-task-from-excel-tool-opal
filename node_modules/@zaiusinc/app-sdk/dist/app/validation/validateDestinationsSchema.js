...
exports.validateDestinationsSchema = validateDestinationsSchema;
const path = __importStar(require("path"));
const SCHEMA_NAME_FORMAT = /^[a-z][a-z0-9_]{1,61}$/;
function validateDestinationsSchema(destinationSchema, file) {
...
class DestinationSchemaValidator {
    ...
    destinationsSchema;
    file;
    constructor(destinationSchema, file) {
    ...
    validateCustomTypeReference(field, pathPrefix) {
        const customTypes = (this.destinationsSchema.custom_types || []).map((ct) => ct.name);
...
//# sourceMappingURL=validateDestinationsSchema.js.map