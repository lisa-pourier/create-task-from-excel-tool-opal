...
require("jest");
const AuthorizationGrantResult_1 = require("../AuthorizationGrantResult");
describe('AuthorizationGrantResult', () => {
    describe('addError', () => {
        it('adds errors for specific fields', () => {
            const result = new AuthorizationGrantResult_1.AuthorizationGrantResult('oauth').addError('username', 'Cannot be blank');
    ...
    describe('getResponse', () => {
        it('produces a response without any errors/etc', () => {
            expect(new AuthorizationGrantResult_1.AuthorizationGrantResult('oauth').getResponse()).toEqual({
                redirect: 'oauth',
        ...
        it('includes errors and toasts in the response', () => {
            const result = new AuthorizationGrantResult_1.AuthorizationGrantResult('foo')
...
//# sourceMappingURL=AuthorizationGrantResult.test.js.map