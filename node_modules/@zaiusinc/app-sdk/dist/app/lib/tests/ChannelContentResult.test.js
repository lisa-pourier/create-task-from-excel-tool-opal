...
require("jest");
const ChannelContentResult_1 = require("../ChannelContentResult");
describe('ChannelContentResult', () => {
    describe('addError', () => {
        it('adds errors for specific fields', () => {
            const result = new ChannelContentResult_1.ChannelContentResult()
    ...
    describe('getResponse', () => {
        it('produces a response no errors or toasts', () => {
            expect(new ChannelContentResult_1.ChannelContentResult().getResponse()).toEqual({
                errors: {},
                toasts: []
            });
        });
...
//# sourceMappingURL=ChannelContentResult.test.js.map