...
require("jest");
const LifecycleSettingsResult_1 = require("../LifecycleSettingsResult");
describe('LifecycleSettingsResult', () => {
    describe('addError', () => {
        it('adds errors for specific fields', () => {
            const result = new LifecycleSettingsResult_1.LifecycleSettingsResult().addError('username', 'Cannot be blank');
    ...
    describe('redirect', () => {
        it('configures a url-mode redirect', () => {
            const result = new LifecycleSettingsResult_1.LifecycleSettingsResult().redirect('https://zaius.com');
    ...
    describe('redirectToSettings', () => {
        it('configures a settings-mode redirect', () => {
            const result = new LifecycleSettingsResult_1.LifecycleSettingsResult().redirectToSettings('foo');
    ...
    describe('getResponse', () => {
        it('produces a response without any errors/etc', () => {
            expect(new LifecycleSettingsResult_1.LifecycleSettingsResult().getResponse('foo')).toEqual({
                redirect: undefined,
        ...
        it('produces a response with a redirect', () => {
            expect(new LifecycleSettingsResult_1.LifecycleSettingsResult().redirect('https://zaius.com').getResponse('foo')).toEqual({
        ...
        it('includes errors prefixed with the section and toasts in the response', () => {
            const result = new LifecycleSettingsResult_1.LifecycleSettingsResult()
...
//# sourceMappingURL=LifecycleSettingsResult.test.js.map