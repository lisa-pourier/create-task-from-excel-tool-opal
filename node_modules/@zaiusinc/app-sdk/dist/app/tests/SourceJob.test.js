...
class MyJob extends SourceJob_1.SourceJob {
    async prepare(_params, _status, _resuming) {
...
describe('Job', () => {
    ...
    describe('sleep', () => {
        ...
        it('sleeps for zero miliseconds if unspecified', async () => {
            ...
            const setTimeoutFn = jest.spyOn(global, 'setTimeout').mockImplementation((resolve) => resolve());
            await job['sleep']();
...
//# sourceMappingURL=SourceJob.test.js.map