...
const validateForm_1 = require("./validateForm");
describe('validateFormDefinition', () => {
    it('succeeds with valid form definition', async () => {
            ...
            sections: [
                {
                    ...
                    elements: [
                        {
                            type: elements_1.ElementType.Text,
                            key: 'email',
                            label: 'Email',
                        ...
                        {
                            type: elements_1.ElementType.Secret,
                            key: 'secret',
                            label: 'Secret',
                        ...
                        {
                            type: index_1.Schema.ElementType.Button,
                            label: 'Login',
                            action: 'login',
                            disabled: {
                                operation: 'any',
        ...
        expect(await (0, validateForm_1.validateFormDefinition)(validForm)).toEqual([]);
    });
    ...
    it('validates json schema for form', async () => {
        ...
        expect(await (0, validateForm_1.validateFormDefinition)(invalidForm)).toEqual([
    ...
    it('validates regexes', async () => {
        ...
        expect(await (0, validateForm_1.validateFormDefinition)(form)).toEqual([
    ...
    describe('validates data', () => {
        const generateForm = (evaluation) => {
            ...
            if ('comparators' in evaluation) {
                const predicate = evaluation;
                element.validations = [
                    {
                        predicate,
                        message: 'Invalid'
                ...
                sections: [
                    {
                        ...
                        properties: ['name'],
                        elements: [{
                                type: elements_1.ElementType.Instructions,
                    ...
                    },
                    {
                        ...
                        elements: [{
                                ...
                                type: elements_1.ElementType.LinkButton,
                                label: 'Visit {{{s2.url}}}',
...
//# sourceMappingURL=validateForm.test.js.map